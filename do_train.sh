...
CMD="python3 src/main.py --d_lr 1e-4 --e_lr 1e-5 --log_img_step 100 --load_path=${LP} --pretrained_model_path=${PRETRAINED} --data_dir ${DATA_DIR} --e_loss_weight 60. --batch_size=64 --use_3d_label True --e_3d_weight 60. --datasets lsp,lsp_ext,mpii,coco,mpi_inf_3dhp,imdb --epoch 75 --log_dir logs"
