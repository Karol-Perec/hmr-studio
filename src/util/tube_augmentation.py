...
from src.util import data_utils2
...
class TubePreprocessor(object):
    ...
    def __init__(self,
        ...
        self.image_normalizing_fn = data_utils2.rescale_image
    ...
    def __call__(self, images, image_sizes, labels, centers, poses, gt3ds,
        ...
        trans_walk = data_utils2.bounded_random_walk(
        ...
        scale_walk = data_utils2.bounded_random_walk(
        ...
        rotate_walk = data_utils2.bounded_random_walk(
    ...
    def preprocess_image(self, image, image_size, label, center, pose, gt3d,
        ...
        with tf.name_scope(None, 'preprocess_images',
            ...
            center = data_utils2.jitter_center(
                center=center,
                rand_trans=tf.reshape(trans, (2, 1))
            )
            # Randomly scale image.
            image, keypoints, center = data_utils2.jitter_scale(
                image=image,
            ...
            image_pad = data_utils2.pad_image_edge(image, margin_safe)
            ...
            if self.rotate_max != 0:
                ...
                crop, crop_kp, gt3d, pose = data_utils2.rotate_img(
                    image=crop,
                    keypoints=crop_kp,
            ...
            crop, crop_kp, new_pose, new_gt3d = tf.cond(
                flip,
                lambda: data_utils2.flip_image(crop, crop_kp, pose, gt3d),
